...
class CharityBeneficiaries extends StatelessWidget {
  static const id = "charity_beneficiaries";

  //String donorPhonenumber;
  //CharityBeneficiaries({required this.donorPhonenumber}) : super();

  @override
  Widget build(BuildContext context) {
    var amountRequired = FirebaseFirestore.instance.collection('charity').doc();

    return Scaffold(
      appBar: kAppBar('charity_var'.tr()),
